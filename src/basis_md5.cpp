...
// Encodes input (uint32) into output (uint8). Assumes length is a multiple of 4.
...
// Decodes input (uint8) into output (uint32). Assumes length is a multiple of 4.

void MD5::decode(const uint8 *input, uint32 *output, uint32 length) 
{
